  ...
  return (
    <div className="sticky top-24 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="bg-gradient-to-b from-gray-100 to-gray-50 rounded-xl border border-gray-200 h-[250px] w-full flex flex-col items-center justify-center p-3 shadow-sm hover:shadow-md transition-shadow">
